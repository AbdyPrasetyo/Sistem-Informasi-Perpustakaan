...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Menu Sirkulasi /</span> Data Pengembalian</h4>
...
<!-- Bordered Table -->
<div class="card mb-4">
    <h5 class="card-header"><a href="{{ url('export_pengembalian') }}" class="btn btn-success">Export Data</a></h5>
    <div class="card-body">
