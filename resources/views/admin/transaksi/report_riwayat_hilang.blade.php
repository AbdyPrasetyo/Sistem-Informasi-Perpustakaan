<style>
    ...
    <hr>
    <h1 class="text-center">Laporan Data Riwayat Pelunasan Buku Hilang</h1>
                ...
                <table class="table1 text-center ">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="align-text-top" width="100px">Kode Buku</th>
                            <th class="align-text-top">NIS</th>
                            <th class="align-text-top" width="50">Nama </th>
                            <th class="align-text-top" width="100px">Tgl Pinjam</th>
                            <th class="align-text-top" width="120px">Tgl Kembali</th>
                            <th class="align-text-top" width="150px">Tgl Dikembalikan</th>
                            <th class="align-text-top">Terlambat</th>
                            <th class="align-text-top" width="100px">Denda</th>
                            <th class="align-text-top" width="50px">Status</th>
