...
<head>
    ...
    <title>SmackOne| Buku Pengunjung</title>
...
<body>
    ...
    <div class="container-xxl">
        ...
        <div class="container mt-4">
            ...
            @if (session('success'))<div class="alert alert-primary alert-dismissible text-center" role="alert">
                {{ session('success') }}
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder"> <span
                                        class="text-uppercase">S</span>mack<span
                                        class="text-uppercase">O</span>ne <span
                                        class="text-uppercase">L</span>ibrary</span>
                            </a>

                        </div>

                        <!-- /Logo -->
                        <h5 class="mb-4">Form Pengunjung Perpustakaan 👋</h5>
                        <form method="POST" action="{{ route('guestssmackonelibrary.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control  @error('nis') is-invalid @enderror" id="nis" name="nis"
                                    placeholder="Masukan NIS atau NIP" autofocus/>
                            ...
                            <div class="mb-3">
                                <label for="nis" class="form-label">Jurusan/Instansi</label>
                                <input type="text" class="form-control  @error('major') is-invalid @enderror" id="major" name="major"
                                    placeholder="Nama Jurusan atau Asal Instansi" autofocus required/>
