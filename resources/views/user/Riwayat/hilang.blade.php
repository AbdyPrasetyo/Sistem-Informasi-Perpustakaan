             ...
             <table class="table table-bordered mb-4 justify-content-center text-center " id="example">
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-text-top">{{ $h->book_code }}</td>
                        <td class="align-text-top">{{ $h->title }}</td>
                        <td class="align-text-top">{{ $h->nis }}</td>
                        <td class="align-text-top">{{ $h->name }}</td>
                        <td class="align-text-top">{{ $h->created }}</td>
                        <td class="align-text-top">{{ $h->deadline }}</td>
                        <td class="align-text-top">{{ $h->return_date }}</td>
                        <td class="align-text-top">
                        <span class="badge bg-label-warning me-1">{{ $h->late }} Hari</span></td>
                        <td class="align-text-top">
                        <span class="badge bg-label-danger me-1">Rp. {{ $h->charge }}</span></td>
                        <td class="align-text-top">
                            <span class="badge bg-label-info me-1">{{ $h->status }}</span>
                        </td>
@endforeach
                 </tbody>
